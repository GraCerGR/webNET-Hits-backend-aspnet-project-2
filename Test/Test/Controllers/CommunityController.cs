...
namespace Test.Controllers
{
    ...
    public class CommunityController : Controller
    {
        ...
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<ActionResult> GetMyCommunity()
        {
            try
            {
        ...
        [ProducesResponseType(typeof(Response), 404)]
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<ActionResult> CreatePostInCommunity([Required] Guid id, CreatePostDto postDto)
        {
            try
            {
                // Получаем идентификатор авторизованного пользователя из токена
        ...
        [ProducesResponseType(typeof(Response), 404)]
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<ActionResult> GetRolePostId(Guid id)
        {
            try
            {
                string authorizationHeader = Request.Headers["Authorization"];
        ...
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<ActionResult> AddSubscribeToPost(Guid id)
        {
            try
            {
        ...
        [ProducesResponseType(typeof(void), 404)]
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<ActionResult> DeleteLikeToPost(Guid id)
        {
            try
            {
                string authorizationHeader = Request.Headers["Authorization"];
        ...
        [ProducesResponseType(typeof(void), 404)]
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<ActionResult> GetPosts([Required] Guid id, [FromQuery] string?[] tags, PostSorting? sorting, [Range(1, int.MaxValue), DefaultValue(1)] int? page, [Range(1, int.MaxValue), DefaultValue(5)] int? size)
        {
            try
            {
